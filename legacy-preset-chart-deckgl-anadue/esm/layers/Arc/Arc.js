...
function setTooltipContent(formData) {
  return o => React.createElement("div", {
    ...
    label: t('Anadue Start (Longitude, Latitude)') + ": ",
    value: o.object.sourcePosition[0] + ", " + o.object.sourcePosition[1]
  }), React.createElement(TooltipRow, {
    label: t('Anadue End (Longitude, Latitude)') + ": ",
...
export function getLayer(fd, payload, onAddFilter, setTooltip) {
  ...
  return new ArcLayer(_extends({
    ...
    strokeWidth: 50000 // fd.stroke_width ? fd.stroke_width*5000 : 3 //Anadue testing Stroke
