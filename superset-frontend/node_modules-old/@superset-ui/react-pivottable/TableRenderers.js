      ...
      value: function renderColHeaderRow(attrName, attrIdx, pivotSettings) {
        ...
        var attrNameCell = _react2.default.createElement(
          'th',
          {
            ...
            onClick: this.clickHeaderHandler(pivotData, colAttrs, this.props.cols, attrIdx, this.props.tableOptions.clickColumnHeaderCallback)
          },
        ...
        while (i < visibleColKeys.length) {
          ...
          var colLabelClass = colSpan > 1 ? 'pvtColLabel' : 'pvtColLabel label-centered';
          if (attrIdx < colKey.length) {
            ...
            attrValueCells.push(_react2.default.createElement(
              ...
              displayHeaderCell(needToggle, (this.state.collapsedCols[flatColKey] ? arrowCollapsed : arrowExpanded) + ' ', onArrowClick, colKey[attrIdx])
            ));
          ...
          rowAttrs.map(function (r, i) {
            ...
            return _react2.default.createElement(
              'th',
              {
                className: 'pvtAxisLabel',
                key: 'rowAttr-' + i,
                onClick: _this7.clickHeaderHandler(pivotData, rowAttrs, _this7.props.rows, i, _this7.props.tableOptions.clickRowHeaderCallback)
              },
              displayHeaderCell(needLabelToggle, subArrow, arrowClickHandle, r)
            );
          }),
          _react2.default.createElement(
            'th',
        ...
        var attrValueCells = rowKey.map(function (r, i) {
          ...
          if (rowSpan > 0) {
            ...
            return _react2.default.createElement(
              ...
              displayHeaderCell(needRowToggle, (_this8.state.collapsedRows[_flatRowKey] ? arrowCollapsed : arrowExpanded) + ' ', onArrowClick, r)
            );
          }
          return null;
        });
