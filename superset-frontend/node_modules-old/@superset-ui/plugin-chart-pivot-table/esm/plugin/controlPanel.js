  ...
  controlPanelSections: [{ ...sections.legacyTimeseriesTime,
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        choices: [// [value, label]
        ['Table With Subtotal', t('Table')], ['Table With Subtotal Heatmap', t('Table Heatmap')], ['Table With Subtotal Col Heatmap', t('Table Col Heatmap')], ['Table With Subtotal Row Heatmap', t('Table Row Heatmap')]],
        renderTrigger: true,
