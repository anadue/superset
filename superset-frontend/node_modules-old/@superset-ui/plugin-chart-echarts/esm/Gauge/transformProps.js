 ...
 * under the License.
 */
import { CategoricalColorNamespace, getNumberFormatter, getMetricLabel } from '@superset-ui/core';
...
export default function transformProps(chartProps) {
  ...
  const axisLabel = {
    distance: axisLineWidth - FONT_SIZE_MULTIPLIERS.axisLabelDistance * fontSize - (showSplitLine ? splitLineLength : 0) - OFFSETS.ticksFromLine,
    fontSize,
