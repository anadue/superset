...
import { D3_TIME_FORMAT_DOCS, sections, sharedControls } from '@superset-ui/chart-controls';
  ...
  controlPanelSections: [sections.legacyTimeseriesTime, {
    ...
    controlSetRows: [['metrics'], ['groupby'], [{
      ...
      config: {
        ...
        choices: [[null, 'None'], [EchartsTimeseriesContributionType.Row, 'Total'], [EchartsTimeseriesContributionType.Column, 'Series']],
        description: t('Calculate contribution per series or total')
      }
    }], ['adhoc_filters'], ['limit', 'timeseries_limit_metric'], [{
      name: 'order_desc',
      config: {
