...
import { FeatureFlag, GenericDataType, isFeatureEnabled, t, validateNumber } from '@superset-ui/core';
import { D3_FORMAT_DOCS, D3_FORMAT_OPTIONS, D3_TIME_FORMAT_OPTIONS, sections, sharedControls } from '@superset-ui/chart-controls';
...
const config = {
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    }, t('Legend'))], isFeatureEnabled(FeatureFlag.DASHBOARD_CROSS_FILTERS) ? [{
      name: 'emit_filter',
      config: {
    ...
    }] : [], [showLegendControl], [legendTypeControl], [legendOrientationControl], [___EmotionJSX("h1", {
      className: "section-header"
    }, t('Labels'))], [{
      name: 'show_labels',
      config: {
