...
import { legendMarginControl, legendOrientationControl, legendTypeControl, noopControl, showLegendControl } from '../controls';
...
function createCustomizeSection(label, controlSuffix) {
  return [[___EmotionJSX("h1", {
    ...
    config: {
      ...
      renderTrigger: true,
      default: seriesType,
      choices: [[EchartsTimeseriesSeriesType.Line, 'Line'], [EchartsTimeseriesSeriesType.Scatter, 'Scatter'], [EchartsTimeseriesSeriesType.Smooth, 'Smooth Line'], [EchartsTimeseriesSeriesType.Bar, 'Bar'], [EchartsTimeseriesSeriesType.Start, 'Step - start'], [EchartsTimeseriesSeriesType.Middle, 'Step - middle'], [EchartsTimeseriesSeriesType.End, 'Step - end']],
    ...
    config: {
      type: 'SelectControl',
      label: t('Y Axis'),
      choices: [[0, t('Primary')], [1, t('Secondary')]],
      default: yAxisIndex,
      renderTrigger: true,
...
const config = {
  controlPanelSections: [sections.legacyTimeseriesTime, createQuerySection(t('Query A'), ''), createQuerySection(t('Query B'), '_b'), {
    ...
    expanded: true,
    controlSetRows: [['color_scheme', 'label_colors'], ...createCustomizeSection(t('Query A'), ''), ...createCustomizeSection(t('Query B'), 'B'), [{
      name: 'zoomable',
      config: {
        type: 'CheckboxControl',
        label: t('Data Zoom'),
      ...
      className: "section-header"
    }, t('Legend'))], [showLegendControl], [legendTypeControl, legendOrientationControl], [legendMarginControl, noopControl], [___EmotionJSX("h1", {
      className: "section-header"
    }, t('X Axis'))], ['x_axis_time_format'], [{
