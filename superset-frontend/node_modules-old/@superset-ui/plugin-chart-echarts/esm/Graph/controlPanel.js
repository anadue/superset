...
import { legendMarginControl, legendOrientationControl, legendTypeControl, showLegendControl } from '../controls';
...
const requiredEntity = { ...sharedControls.entity,
  clearable: false
};
const optionalEntity = { ...sharedControls.entity,
  clearable: true,
  validators: []
};
const controlPanel = {
  controlPanelSections: [sections.legacyRegularTime, {
    ...
    expanded: true,
    controlSetRows: [['color_scheme'], [___EmotionJSX("h1", {
      ...
      config: {
        ...
        options: [['force', t('Force')], ['circular', t('Circular')]],
      ...
      config: {
        ...
        choices: [['none,none', t('None -> None')], ['none,arrow', t('None -> Arrow')], ['circle,arrow', t('Circle -> Arrow')], ['circle,circle', t('Circle -> Circle')]]
      }
    }], [{
      name: 'draggable',
      config: {
      ...
      config: {
        ...
        choices: [[false, t('Disabled')], ['scale', t('Scale only')], ['move', t('Move only')], [true, t('Scale and Move')]],
      ...
      config: {
        ...
        choices: [[false, t('Disabled')], ['single', t('Single')], ['multiple', t('Multiple')]],
