...
function getPadding(showLegend, legendOrientation, addYAxisLabelOffset, zoomable, margin) {
  const yAxisOffset = addYAxisLabelOffset ? _constants.TIMESERIES_CONSTANTS.yAxisLabelTopOffset : 0;
  return (0, _series.getChartPadding)(showLegend, legendOrientation, margin, {
    top: _constants.TIMESERIES_CONSTANTS.gridOffsetTop + yAxisOffset,
    bottom: zoomable ? _constants.TIMESERIES_CONSTANTS.gridOffsetBottomZoomable : _constants.TIMESERIES_CONSTANTS.gridOffsetBottom,
    left: _constants.TIMESERIES_CONSTANTS.gridOffsetLeft,
    right: showLegend && legendOrientation === _types.LegendOrientation.Right ? 0 : _constants.TIMESERIES_CONSTANTS.gridOffsetRight
  });
}

function getTooltipFormatter(format) {
