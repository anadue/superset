 ...
 * under the License.
 */
import { AnnotationData, AnnotationLayer, CategoricalColorScale, EventAnnotationLayer, IntervalAnnotationLayer, TimeFormatter, TimeseriesAnnotationLayer, TimeseriesDataRecord } from '@superset-ui/core';
...
export declare function transformFormulaAnnotation(layer: AnnotationLayer, data: TimeseriesDataRecord[], colorScale: CategoricalColorScale): SeriesOption;
...
export declare function getPadding(showLegend: boolean, legendOrientation: LegendOrientation, addYAxisLabelOffset: boolean, zoomable: boolean, margin?: string | number | null): {
    bottom: number;
    left: number;
    right: number;
    top: number;
};
export declare function getTooltipFormatter(format?: string): TimeFormatter | StringConstructor;
