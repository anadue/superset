...
function buildQuery(formData) {
  ...
  const queryContextA = (0, _core.buildQueryContext)(formData1, baseQueryObject => {
    const metricLabels = (baseQueryObject.metrics || []).map(_core.getMetricLabel);
  ...
  const queryContextB = (0, _core.buildQueryContext)(formData2, baseQueryObject => {
    const metricLabels = (baseQueryObject.metrics || []).map(_core.getMetricLabel);
    return [{ ...baseQueryObject,
      is_timeseries: true,
      post_processing: [{
