...
export function ColumnTypeLabel({
  ...
  const type = type_ === undefined || type_ === null ? '?' : type_ === GenericDataType.BOOLEAN ? 'bool' : type_ === GenericDataType.NUMERIC ? 'FLOAT' : type_ === GenericDataType.TEMPORAL ? 'time' : type_ === GenericDataType.STRING ? 'string' : type_;
  let stringIcon;
