...
function CertifiedIconWithTooltip({
  ...
  return ___EmotionJSX(OverlayTrigger, {
    placement: "top",
    overlay: ___EmotionJSX(Tooltip, {
      id: `${kebabCase(metricName)}-tooltip`,
      style: tooltipStyle
    }, certifiedBy && ___EmotionJSX("div", null, t('Certified by %s', certifiedBy)), ___EmotionJSX("div", null, details))
  }, ___EmotionJSX("svg", {
