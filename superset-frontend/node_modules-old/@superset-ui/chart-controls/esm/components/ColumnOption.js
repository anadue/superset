...
export function ColumnOption({
  ...
  return ___EmotionJSX("span", null, showType && columnType && ___EmotionJSX(ColumnTypeLabel, {
    type: columnType
  ...
  }, column.verbose_name || column.column_name)), column.description && ___EmotionJSX(InfoTooltipWithTrigger, {
    className: "m-r-5 text-muted",
    icon: "info",
    tooltip: column.description,
    label: `descr-${column.column_name}`,
    placement: "top"
  }), hasExpression && ___EmotionJSX(InfoTooltipWithTrigger, {
    className: "m-r-5 text-muted",
