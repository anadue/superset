...
export const dndColumnsControl = { ...dndGroupByControl,
  label: t('Columns'),
  description: t('One or many columns to pivot as columns')
};
export const dndSeries = { ...dndGroupByControl,
  label: t('Series'),
  multi: false,
  default: null,
...
export const dndEntity = { ...dndGroupByControl,
  label: t('Entity'),
  default: null,
  multi: false,
...
export const dnd_adhoc_metric = { ...dnd_adhoc_metrics,
  multi: false,
  label: t('Metric'),
  description: t('Metric'),
  default: c => mainMetric(c.savedMetrics)
};
export const dnd_timeseries_limit_metric = {
  type: 'DndMetricSelect',
  label: t('Sort by'),
  default: null,
