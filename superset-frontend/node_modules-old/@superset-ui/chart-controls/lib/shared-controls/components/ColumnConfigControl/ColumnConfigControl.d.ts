 ...
 */
export default function ColumnConfigControl<T extends ColumnConfig>({ queryResponse, appliedColumnNames, value, onChange, configFormLayout, ...props }: ColumnConfigControlProps<T>): JSX.Element | null;
