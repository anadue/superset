...
class SupersetIndexView(IndexView):
    ...
    def index(self) -> FlaskResponse:
        ...
        redirectLoadView = current_app.config["SUPERSET_HOME_LANDING_PAGE"]
        if current_app.config["ANADUE_LANDING_PAGE"]:
            redirectLoadView =  current_app.config["ANADUE_LANDING_PAGE"]
        
        #return redirectLoadView;
            
        return redirect(redirectLoadView) 
        #return redirect(self.config["ANADUE_LANDING_PAGE"])
